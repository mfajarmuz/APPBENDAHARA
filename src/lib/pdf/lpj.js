...
export function exportLPJPeriodePdf(monthIndex, year, allSubKegiatan, pengeluaran, penerimaan, midDate, endDateSelected) {
  ...
  const saldoKasRiil = totalPenerimaanAgg.gu.sd - totalPengeluaranAgg.gu.sd; const sR = new Array(3).fill('-'); sR[0] = { content: 'Saldo Kas', colSpan: 12, styles: { fontStyle: 'bold', halign: 'right' } }; sR[1] = { content: fmt(saldoKasRiil), styles: { fontStyle: 'bold', halign: 'right' } }; sR[2] = '-'; body.push(sR)
