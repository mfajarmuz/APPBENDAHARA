...
import { Save, Building2, UserCheck, RefreshCcw, AlertCircle, Laptop, Download, Power, Cloud, CheckCircle2, XCircle, Trash2, Undo } from 'lucide-react'
...
export default function Settings() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="p-6 mt-8 border-t-4 border-t-rose-500 shadow-md shadow-rose-500/5">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2 text-rose-600">
            <Trash2 size={18} />
            <h3 className="font-bold text-sm uppercase tracking-wider">Tempat Sampah (Soft Delete)</h3>
          </div>
        ...
        <div className="space-y-4">
          <p className="text-xs text-slate-500 leading-relaxed">
            Berikut adalah data transaksi Penerimaan dan Pengeluaran yang telah dihapus sementara. Anda dapat memulihkannya kembali ke halaman asal atau menghapusnya secara permanen dari database.
          </p>
